    ...
    */         
    public void display(GLAutoDrawable drawable) {
        ...
        gl3.glUseProgram(shader_program_ref);
        {
            ...
            FloatUtil.invertMatrix(model_view_matrix, inverse_model_view_matrix);
            FloatUtil.transposeMatrix(inverse_model_view_matrix, transpose_inverse_model_view_matrix); 
